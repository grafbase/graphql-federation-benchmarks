...
│   ├── benchmark.rs      # Benchmark discovery and management
...
### Benchmark Manager (`src/benchmark.rs`)

- Discovers benchmarks from `benchmarks/` directory
- Validates benchmark structure and requirements
- Provides benchmark metadata and paths

### Configuration (`src/config.rs`)

- Loads global configuration from `config.toml`
- Loads gateway configurations from benchmark TOML files
